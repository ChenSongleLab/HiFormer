...
def train_one_epoch(train_loader, model, optimizer, scaler, summary_writer, log_writer, epoch, countdown, args):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        pred_part_poses, loss, trans_l2_loss, rot_l2_loss, rot_cd_loss, shape_cd_loss, pointnet_loss, box_loss, output \
            = model(part_pcs, part_valids, gt_part_poses, match_ids, part_ids, num_group, num_group_part, parts_valid_in_group, groups_valid, flat2group_index, group2flat_index)
