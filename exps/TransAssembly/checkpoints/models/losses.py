...
def comp_group_losses(preds, gt_poses, part_pcs, part_valids, match_ids, args=None, **kwargs):
    ...
    for trans_ind in range(num_trans):
        ...
        for bs_ind in range(batch_size):
            ...
            for ins_id in range(1, num_part + 1):
                ...
                parts_box_per_trans[bs_ind, need_to_match_part] = cur_pred_box[matched_pred_ids]
        ...
        box_loss_per_trans = get_total_box_loss(part_pcs, pred_rot, gt_rot, pred_trans, gt_trans, part_valids, flat2group_index_1d, \
                                                part_valids_group_mask, groups_valid, shape_box_per_trans, groups_box_per_trans, parts_box_per_trans)


        group_loss_per_trans = get_group_loss(part_pcs, pred_rot, gt_rot, pred_trans, gt_trans, part_valids, flat2group_index_1d, \
    ...
    return total_loss, total_trans_l2_loss, total_rot_l2_loss, total_rot_cd_loss, total_shape_cd_loss, total_box_loss, total_group_cd_loss
