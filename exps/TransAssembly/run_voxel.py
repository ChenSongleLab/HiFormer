...
parser.add_argument('--output-dir', default="/media/user/data/chensl/assemble_run/backbone_swing0515/swtrans/", type=str)
parser.add_argument('-p', '--print-freq', default=20, type=int,
                    metavar='N', help='print frequency (default: 10)')
parser.add_argument('--save-freq', default=1, type=int,
                    metavar='N', help='save frequency (default: 10)')
parser.add_argument('--resume', default="/media/user/data/chensl/assemble_run/backbone_swing0515/swtrans/checkpoint.pth.tar", type=str, metavar='PATH',
...
parser.add_argument('--backbone', default='swin_transformer', type=str, help='pointnet_cls, minkowski, swin_transformer, the backbone to extract init features.')
...
parser.add_argument('--classes', default=12, type=int, help='这个是和每个点对应的特征类似的，得到每个点的类别')
