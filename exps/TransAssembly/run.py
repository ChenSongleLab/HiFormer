...
from models.trans_assembly_encoder import TransAssembly_encoder
...
parser.add_argument('--data_dir', type=str, default='/media/user/data/shanglei/prepare_data', help='data directory')
...
parser.add_argument('--wd', '--weight-decay', default=1e-4, type=float,
                    ...
                    dest='weight_decay')
parser.add_argument('--output-dir', default="/media/user/data/chensl/assemble_run/assemble_box_guide_20240506/", type=str)
parser.add_argument('-p', '--print-freq', default=20, type=int,
                    metavar='N', help='print frequency (default: 10)')
parser.add_argument('--save-freq', default=1, type=int,
                    metavar='N', help='save frequency (default: 10)')
parser.add_argument('--resume', default="/media/user/data/chensl/assemble_run/assemble_box_guide_20240506/checkpoint.pth.tar", type=str, metavar='PATH',
...
parser.add_argument('--backbone', default='minkowski', type=str, help='pointnet_cls, minkowski, the backbone to extract init features.')
...
parser.add_argument('--debug-on', default=0, type=int, help='Whether to apply gt visualization.')
