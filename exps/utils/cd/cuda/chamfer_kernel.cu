...
std::vector<at::Tensor> ChamferBackward(
  ...
  //THArgCheck(at::cuda::getApplyGrid(batch_size * n1, grid1, curDevice), 1, "Too many elements to calculate");  # comment by csl
  //THArgCheck(at::cuda::getApplyGrid(batch_size * n2, grid2, curDevice), 1, "Too many elements to calculate");  # comment by csl
